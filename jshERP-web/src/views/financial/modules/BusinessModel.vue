<template>
  <div>
    <a-modal
      ...
      :title="showComponentList[showComponentInd].title"
...
<script>
import MoneyOut from '../MoneyOutList.vue'
import InDetail from '../../report/InDetail.vue'
  ...
  data() {
    return {
      ...
      showComponentList: [
        ...
        { name: 'ItemOut', title: '支出单', extraData: {} },
      ],
    }
  },
  methods: {
